...
public class CheckoutTest {
    ...
    public void checkoutCalculatesTotalCost() {
        ...
        basket.add(shop.getProduct(Shop.PRODUCT_ID_APPLE)); // free
        basket.add(shop.getProduct(Shop.PRODUCT_ID_ORANGE));
        basket.add(shop.getProduct(Shop.PRODUCT_ID_ORANGE)); // free
        basket.add(shop.getProduct(Shop.PRODUCT_ID_APPLE));
        basket.add(shop.getProduct(Shop.PRODUCT_ID_APPLE)); // free
        basket.add(shop.getProduct(Shop.PRODUCT_ID_ORANGE));
        basket.add(shop.getProduct(Shop.PRODUCT_ID_ORANGE));
        ...
        Assert.assertEquals(new BigDecimal("2.80"), totalCost);
    }
}
